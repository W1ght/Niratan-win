...
public sealed class ProfileService : IProfileService
{
    ...
    public IReadOnlyList<HoshiProfile> Profiles => _index.Profiles;
    ...
    public async Task<HoshiProfile> CreateProfileAsync(
        string name,
        string languageId,
        ...
        CancellationToken ct = default)
    {
        ...
        var profile = new HoshiProfile(id, safeName, language.Id);
    ...
    private HoshiProfile ResolveBook(ProfileContext context)
    {
    ...
    private HoshiProfile ResolveExplicitOrFallback(string? profileId) =>
    ...
    private void EnsureBuiltInProfiles()
    {
        ...
        {
            _index.Profiles.Add(new HoshiProfile(
