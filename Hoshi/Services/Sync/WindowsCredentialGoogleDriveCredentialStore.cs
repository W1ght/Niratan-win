...
{
    private const string TargetName = "Hoshi.TtuSync.GoogleDriveCredentials";
    ...
    public bool HasCredentials => ReadCredential() != null;
    ...
    private static GoogleDriveCredentials? ReadCredential()
    {
